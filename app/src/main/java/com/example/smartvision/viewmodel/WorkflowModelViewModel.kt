...
package com.example.smartvision.viewmodel
...
import com.example.smartvision.objectdetection.DetectedObjectInfo
import com.example.smartvision.birdsearch.model.Bird
import com.example.smartvision.birdsearch.model.SearchedObject
import com.example.smartvision.settings.PreferenceUtils
import java.util.HashSet

/** View model for handling application workflow based on camera preview.  */
class WorkflowModelViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun onSearchCompleted(detectedObject: DetectedObjectInfo, birds: List<Bird>) {
        ...
        searchedObject.value = SearchedObject(context.resources, lConfirmedObject, birds)
    }
}
