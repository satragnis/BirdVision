...
//import com.example.smartvision.productsearch.ui.BottomSheetScrimView
//import com.example.smartvision.productsearch.adapter.ProductAdapter
...
//import com.example.smartvision.productsearch.SearchEngine
...
//
//
//class MainActivity : AppCompatActivity(), OnClickListener, PermissionListener {
...
//    private var workflowModelViewModel: WorkflowModelViewModel? = null
...
//        super.onResume()
//
//        workflowModelViewModel?.markCameraFrozen()
//        settingsButton?.isEnabled = true
//        bottomSheetBehavior?.state = BottomSheetBehavior.STATE_HIDDEN
//        currentWorkflowState = WorkflowState.NOT_STARTED
//        cameraSource?.setFrameProcessor(
//            if (PreferenceUtils.isMultipleObjectsMode(this)) {
//                MultiObjectProcessor(graphicOverlay!!, workflowModelViewModel!!, CUSTOM_MODEL_PATH)
//            } else {
//                ProminentObjectProcessor(graphicOverlay!!, workflowModelViewModel!!, CUSTOM_MODEL_PATH)
//            }
//        )
//        workflowModelViewModel?.setWorkflowState(WorkflowState.DETECTING)
//    }
//
...
//                workflowModelViewModel?.onSearchButtonClicked()
//            }
...
//        val workflowModel = this.workflowModelViewModel ?: return
...
//        if (workflowModelViewModel?.isCameraLive == true) {
//            workflowModelViewModel!!.markCameraFrozen()
//            flashButton?.isSelected = false
//            preview?.stop()
//        }
...
//
//                    when (newState) {
//                        BottomSheetBehavior.STATE_HIDDEN -> workflowModelViewModel?.setWorkflowState(WorkflowState.DETECTING)
...
//                    val searchedObject = workflowModelViewModel!!.searchedObject.value
...
//        workflowModelViewModel = ViewModelProviders.of(this).get(WorkflowModelViewModel::class.java).apply {
//
...
//            objectToSearch.observe(this@MainActivity, Observer { detectObject ->
//                searchEngine!!.search(detectObject) { detectedObject, products ->
//                    workflowModelViewModel?.onSearchCompleted(detectedObject, products)
//                }
//            })
//
//            // Observes changes on the object that has search completed, if happens, show the bottom sheet
//            // to present search result.
//            searchedObject.observe(this@MainActivity, Observer { nullableSearchedObject ->
